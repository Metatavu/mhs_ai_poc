...
export interface DocIndexRequest {
  id: string,
  articleId: string,
  articleUrl: string,
  articleTitle: string,
 ...
 */
export async function knnSearch(query: string, lang: string) {
 ...
 * @param lang Language
 */
export async function index(req: DocIndexRequest, lang: string) {
  client.index({
 ...
 */
async function configureIngestPipeline(apiKey: string, modelId: string) {
